...
const NewDm = () => {
    ...
    const searchContacts = async (searchTerm) => {
        try {
            ...
            console.log("Error while Seaerch contacts", error)
        }
    }
                                            ...
                                            <div className='w-10 h-10 relative'>
                                                <Avatar className="w-10 h-10  rounded-full overflow-hidden" >
                                                    {Contact.profilePicture ? (
                                                        <AvatarImage src={`${HOST}/${Contact.profilePicture}`} alt="profile" className="object-cover w-full h-full bg-black rounded-full " />
                                                    ) : (
